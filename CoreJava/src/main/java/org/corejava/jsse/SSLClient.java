...
public class SSLClient {
    ...
    public void init() {
        try {
            ...
            // 载入keystore
            ks.load(SSLServer.class.getClassLoader().getResourceAsStream("org/corejava/classloader/kclient.keystore"),
                CLIENT_KEY_STORE_PASSWORD.toCharArray());
            tks.load(SSLServer.class.getClassLoader().getResourceAsStream("org/corejava/classloader/tclient.keystore"),
